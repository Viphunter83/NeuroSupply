        ...
        <div className="space-y-6">
            ...
            <Card className="border-none shadow-xl bg-card/50 backdrop-blur-md">
                <CardHeader>
                    ...
                    <CardDescription>Все пользователи, вошедшие через Telegram бот</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <Card className="border-none bg-blue-500/5">
                    ...
                    <CardContent className="text-xs text-muted-foreground space-y-2">
                        <p>1. Попросите сотрудника открыть Telegram бот.</p>
                        <p>2. Он появится в этом списке автоматически.</p>
                        <p>3. Выберите нужную роль и ресторан здесь.</p>
                    </CardContent>
                </Card>
